...
\begin{tikzpicture}
	...
	\draw (-3.0, -0.3) node[anchor=north,fill=white] {\textit{\tiny Per-instance feature vectors}};
	\draw (0.0, -0.3) node[anchor=north,fill=white] {\textit{\tiny Per-url-part feature vectors}};
	\draw (3.25, -0.3) node[anchor=north,fill=white] {\textit{\tiny Per-url feature vector}};
	...
	\draw[->] (-4.6, -1.15) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0) ;
	\draw[->] (-4.6, -1.65) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -2.15) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -2.95) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -3.45) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -3.95) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -4.75) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -5.25) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
	\draw[->] (-4.6, -5.75) -- node[above] { \tiny \( \phi \)} ++ (0.4, 0);
